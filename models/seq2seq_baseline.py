...
def train_baseline_seq2seq_model_GRU(mfcc_features, target_length, latent_dim, word_level):
    ...
    pre_decoder_dense_layer = Dense(38, activation="relu", name="pre_decoder_dense")
    decoder_entries = pre_decoder_dense_layer(decoder_inputs)
    pre_decoder_dense2_layer = Dense(29, activation="relu", name="pre_decoder_dense2")
    decoder_entries = pre_decoder_dense2_layer(decoder_entries)
